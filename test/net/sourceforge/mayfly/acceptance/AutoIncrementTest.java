...
public class AutoIncrementTest extends SqlTestCase {
    ...
    /* TODO: what about the case of inserting 92, 70, then default?
       Does AUTO_INCREMENT imply one higher than the highest?
       Or one higher than the last? */
    ...
    public void testConflicting() throws Exception {
        ...
        if (dialect.autoIncrementIsRelativeToLastValue()) {
            ...
            /* TODO: now try inserting another one.  Has the identity value
               been incremented (so the second one works)? */
        }
    }
